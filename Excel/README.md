...
before freight expense file is uploaded into ERP system in order to identify invalid GL codes.
Prevents freight expense accrual upload issues due to wrong GL accounts. 
...
Freight expense data is converted into file for automatic upload into ERP system for accounting close.
