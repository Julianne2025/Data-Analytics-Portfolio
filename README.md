...
Now this invoice and chart of accounts data are imported into Power BI from SQL Server for demonstration purposes.  Fact and COA tables are used. DAX measures are created.  Dashboards are published to my Power BI Service account.
